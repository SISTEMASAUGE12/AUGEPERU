...
?>
	<div class="callout callout-2"><div class="row ">
			...
			<div class="parte-medio">
				...
				<div class="medium-8 columns end ">
					...
					<div class="parte-medio descr">
						<?php echo $bloga['avance'] ?>
					</div>

					<div class="parte-medio text-center " style="margin:10px 0 10px;">
				<?php  if(!empty($bloga['link_grupo_wasap']) ){ ?>

						<a href="<?php echo $bloga['link_grupo_wasap']; ?>" title="  canal_wsp_flota" target="_blank" class=" canal_wsp_flota  poppi  "  >
							<img src="img/iconos/ws.png" alt="Únete a nuestro  canal de whatsApp "> COMUNÍCATE CON NOSOTROS
						</a>
				<?php }else{  ?> 
		...
		<div class="medium-8  columns" style="padding-bottom:60px;">
	<?php
		if(!empty($bloga['link']) ){ 
		...
		<div class="medium-4   columns " style="padding-bottom:50px;">
				<?php include("inc_publicidad_blog.php"); ?>
		</div> <!--  end publicidad -->
	...
	<div class="formulario_blog poppi hide ">
