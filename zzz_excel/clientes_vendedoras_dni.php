...
<div class="container">
<h2 style="padding-top:40px;">Cargar e importar archivo excel a Base de Datos: <b>Clientes por DNI </b>: educaauge.com</h2>
...
for ($i=2;$i<=$filas;$i++){
	...
	$_DATOS_EXCEL[$i]['dni'] = $objPHPExcel->getActiveSheet()->getCell('D'.$i)->getCalculatedValue();
