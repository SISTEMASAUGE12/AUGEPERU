...
header('Content-Disposition: attachment;filename=bcp_que_no_estan_en_sistema_'.$hora.'.xls ');  
header('Content-Transfer-Encoding: binary ');
?>
<table cellspacing='0' cellpadding='0' width='50%' style='font-size:18px;'>
<tr> <td colspan='4' align='center'><b><font size='+2'>VOUCHER <b>BCP</b> NO ENCONTRADOS EN EL SISTEMA</font></b></td> </tr>
<tr>
