...
header('Content-Disposition: attachment;filename=bbva_voucher_del_sistema_que_no_excel_'.$hora.'.xls ');  
header('Content-Transfer-Encoding: binary ');
?>
<table cellspacing='0' cellpadding='0' width='50%' style='font-size:18px;'>
<tr> <td colspan='4' align='center'><b><font size='+2'>VOUCHER <b>BBVA</b> DEL SISTEMA NO ENCONTRADOS EN EL EXCEL </font></b></td> </tr>
<tr>
