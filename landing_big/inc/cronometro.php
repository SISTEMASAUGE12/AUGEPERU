...
<?php
	...
	$fecha_inicio = strtotime($landings_bigs[0]["fecha_inicio"]);
...
<div  class="blanco  text-center ">
				<h4 class="poppi bold  "> LA INSCRIPCIÓN FINALIZA EN <?php  //echo $landings_bigs[0]["fecha_inicio"].' -- '.$landings_bigs[0]["hora_inicio"]; ?> </h4>
				<div id="countdown" ></div>
			</div>
			
<script>
// var end = new Date('<?php echo $landings_bigs[0]["fecha_inicio"] ?> 11:59 PM');
var end = new Date('<?php echo $landings_bigs[0]["fecha_inicio"] ?> <?php echo $landings_bigs[0]["hora_inicio"] ?> ');
