...
?>
<!-- * empieza la web -->
<div class="container fullContainer  cornersAll radius0 shadow0 bgNoRepeat emptySection" id="section--89947-189"  style="padding-top: 80px; padding-bottom: 45px; outline: none; color: rgb(255, 255, 255); background-color: rgb(28, 28, 28);"  data-animate="fade" >
  <div class="containerInner ui-sortable">
          ...
          <div id="col-full-130-140" class="col-md-12 innerContent col_left">
            <div class="col-inner bgCover  noBorder borderSolid border3px cornersAll radius0 shadow0 P0-top P0-bottom P0H noTopMargin" style="padding: 0 10px">
              <div class="de elImageWrapper de-image-block elAlign_center elMargin0 ui-droppable de-editable" id="tmp_image-44826-188" style="margin-top: 0px; outline: none; cursor: pointer;" aria-disabled="false">
                <img src="img/logo-rojo.png" class="elIMG ximg" alt="" width=" " tabindex="0">
              </div>
            </div>
          </div>
        </div>
        ...
        <div class="row bgCover noBorder borderSolid border3px cornersAll radius0 shadow0 P0-top P0-bottom P0H noTopMargin" id="row--69890"   style="padding-top: 20px; padding-bottom: 0px; margin: 0px auto; outline: none; width: 95%; max-width: 100%;">
          <div id="col-full-136" class="col-md-12 innerContent col_left"   data-animate="fade"   style="outline: none;">
            <div class="col-inner bgCover  noBorder borderSolid border3px cornersAll radius0 shadow0 P0-top P0-bottom P0H noTopMargin" style="padding: 0 10px">
              <div class="de elHeadlineWrapper ui-droppable de-editable" id="tmp_subheadline-45387-106"  data-animate="fade"  data-gramm="false" style="margin-top: 0px; outline: none; cursor: pointer;" >
                <h2 h2 class="ne elHeadline hsSize2 lh3 elMargin0 elBGStyle0 hsTextShadow0 mfs_16" style="text-align: center; font-size: 20px; color: rgb(255, 255, 255);"  ><b><u> <?php echo $landings_bigs[0]['ante_titulo']; ?>  </u></b></h2>  
              </div>
        ...
        <div class="row bgCover noBorder borderSolid border3px cornersAll radius0 shadow0 P0-top P0-bottom P0H noTopMargin" id="row--57240-109"  data-animate="fade" style="padding-top: 20px; padding-bottom: 20px; margin: 0px; outline: none;">
