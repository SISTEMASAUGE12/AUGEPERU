	...
	if(!empty($_GET['fechabus_1']) && !empty($_GET['fechabus_2'])) {
		...
		?>        
					...
					// include("lista_de_comision_actual.php");
						...
						<td class="cnone hide"> s/. <?php echo $comision_propia= ($ventas_clientes_nuevos[0]["n_total_soles"] > 0) ?$ventas_clientes_nuevos[0]["n_total_soles"]:0; ?></td>
						...
						<td class="cnone hide"> s/ <?php  echo $comision_compartida= $ventas_compartidas[0]["total_venta_soles_compartida"]; ?></td>

						<!--  comision cliente antiguo -->
						<td class="cnone">  <?php echo $ventas_sin_copmision_antiguos[0]['total_ventas_sin_comision']; ?> </td>
						<td class="cnone hide"> s/  <?php echo $ventas_sin_copmision_antiguos[0]['total_ventas_cliente_antiguos']; ?></td>										
						...
						<td class=" hide"> <b>s/.  <?php echo $total_comisionar; ?> </b></td>
...
<?php
	...
	<?php  if($_SESSION["visualiza"]["idtipo_usu"] ==13){ ?>
...
<script>
var link = "pedidos_vendedores_2024_por_porcentaje_solo_jefa_ventas";/*la s final se agrega en js fuctions*/
...
var ar = "al";
var id = "id_pedido";
var mypage = "pedidos_vendedores_2024_por_porcentajes_solo_jefa_ventas.php";
</script>
<?php } ?>