...
define ('PDF_PAGE_ORIENTATION', 'L');  // echado
...
define ('PDF_HEADER_TITLE', 'Tuweb7.com');
...
define ('K_PATH_IMAGES', '../files/images/certificados/'.$imagen_fondo_certificado);   // sale de BD en certificado.php 
define ('IMG_FONDO_BLANCO', dirname(__FILE__).'/../images/fondo_blanco.jpg');   // sale de BD en certificado.php 
