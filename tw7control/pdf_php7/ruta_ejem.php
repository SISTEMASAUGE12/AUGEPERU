...
$pdf->SetAuthor('Ing. Luis Mori');
$pdf->SetTitle('Reporte lista de pasajeros de tours');// titulo del archivo
$pdf->SetSubject('www.tuweb7.com');
$pdf->SetKeywords('TCPDF, PDF, ruta, test, guide');

// set default header data
$pdf->SetHeaderData(LOGO,LOGO_WIDTH, "Calle Manco Capac  551, Urb San Juan – Centro de Chiclayo.", TITULO_HEADER);//cabezera
...
// p es automatica
$html = '<h1>Probando Creacion de reporte.</h1>
<h2>'.$titulo.'</h2>
'.$des.'
<img src="'.$img.'" alt="" style="text-align:center;" border="0" />
