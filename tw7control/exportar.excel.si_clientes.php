...
$hora = time();
$name_archivo  = 'Reporte_clientes_con_compras__'.$_GET['fecha_filtro_inicio'].'_al_'.$_GET['fecha_filtro_fin'];
$title  = 'Reporte de  Clientes con compras: '.$_GET['fecha_filtro_inicio'].' al '.$_GET['fecha_filtro_fin'];
  ...
  if( !empty($data) )   {
		...
		foreach($data as $detalles) {
			...
			echo "<tr>";
				...
				// echo "<td>".$detalles['gastototal']."</td>"; 		 		
			echo '</tr>';
