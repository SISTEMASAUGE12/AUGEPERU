...
if($_POST["task"]=='atender_cliente_insertar_kardex' ){
 ...
 ORDER BY s.id_suscrito DESC";
  ...
  $paging->ejecutar();
  $paging->pagina_proceso="reportes_todos_clientes.php";
?>
  <table id="example1" class="table table-bordered table-striped">

<?php 

if($_SESSION["visualiza"]["idtipo_usu"] ==1 &&  ($_SESSION["visualiza"]["idusuario"] ==6 || $_SESSION["visualiza"]["idusuario"] ==80 ) ){  ?> 
		...
		<a href="../datausuario_solo_peru.php" class="btn btn-primary"  style="margin-left:20px;"> Excel [descargar Perú]</a>
		<a href="../datausuario_solo_extranjeros.php" class="btn btn-primary"  style="margin-left:20px;"> Excel [descargar Extranjeros]</a>
            ...
            <div class="row">
              <div class="col-sm-12">
                ...
                <div id="div_oculto" style="display: none;"></div>
						...
						<?php 
							$pagina_destino="reportes_todos_clientes";
...
var ar = "al";
var id = "id_pedido";
var mypage = "reportes_todos_clientes.php";
</script>
<?php } ?>