...
if($_GET["task"]=='uestado'){
  ...
  $bd->close();
    ...
    $fecha = fecha_hora(2);
    $fecha_1 = strtotime('-15 minute',strtotime($fecha));  // tolerancia desde hace 15min 
    ...
    $paging->ejecutar();
    $paging->pagina_proceso="reporte_asistencias.php";
?>
...
?>
		...
		<a href="javascript:fn_exportar('tipo_form=1&fecha_filtro_inicio=<?php echo $fecha_excel_inicio;?>&fecha_filtro_fin=<?php echo $_GET["fechabus_2"];?>','asistencias');" class="btn btn-primary excel"  > Excel</a>
            ...
            <form action="javascript: fn_buscar();" id="frm_buscar" name="frm_buscar">
              <div class="bg-gray-light">
							 	<div class="col-sm-12 titulo_reporte criterio_buscar">
									<h4>Reporte de clientes conectados en este momento:</h4>
								</div>
...
<script>
var link = "reporte_asistencia";/*la s final se agrega en js fuctions*/
var us = "reporte_asistencia";/*sirve para mensaje en ventana eliminar*/
var l = "o";
var l2 = "e";/* est+ _ x {e,a,o ,etc}sirve para mensaje en ventana eliminar*/
var pr = "El";
var ar = "al";
var id = "id_asistencia";
var mypage = "reporte_asistencias.php";
</script>
<?php } ?>