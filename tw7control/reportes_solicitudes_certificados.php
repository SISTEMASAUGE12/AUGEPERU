...
if($_GET["task"]=='finder'){
  ...
  $sql= "SELECT sol.*,YEAR(sol.fecha_registro) as anho, MONTH(sol.fecha_registro) as mes, e.nombre AS estado ,s.email as email,  CONCAT(s.nombre,' ',s.ap_pa,' ',s.ap_ma )as suscritos , s.dni as dni, s.telefono, c.codigo, c.titulo, pp.codigo as codped, pp.tipo_pago, ce.id_certificado, ce.titulo as certificado, ce.precio as precioc, sol.estado as estado_envio 
		FROM solicitudes sol   
		INNER JOIN linea_pedido lp ON sol.id_certificado = lp.id_curso  
  	...
  	INNER JOIN certificados ce ON sol.id_certificado=ce.id_certificado  
  	INNER JOIN cursos c ON sol.id_curso=c.id_curso ";
...
// echo $sql;
  ...
  $paging->ejecutar();
  $paging->pagina_proceso="reportes_solicitudes_certificados.php";
?>
  <table id="example1" class="table table-bordered table-striped">
		...
		<a href="javascript:fn_exportar('tipo_form=1&fecha_filtro_inicio=<?php echo $fecha_excel_inicio;?>&fecha_filtro_fin=<?php echo $_GET["fechabus_2"];?>','solicitudes_certificados');" class="btn btn-primary excel "  > Excel</a>
...
?>        
       <tr>
        ...
        <td class="cnone"><?php
        	if($detalles["estado_envio"]==1){ echo 'Entregado';
        	}elseif($detalles["estado_envio"]==2){ echo 'Pendiente';
        	}elseif($detalles["estado_envio"]==3){ echo 'Rechazado';
        	}elseif($detalles["estado_envio"]==4){ echo 'Procesando';
        	}elseif($detalles["estado_envio"]==5){ echo 'Enviado';
        	}
       ?></td>
      </tr>
<?php endwhile; ?>
            ...
            <form action="javascript: fn_buscar();" id="frm_buscar" name="frm_buscar">
              <div class="bg-gray-light">
								<div class="col-sm-12 titulo_reporte criterio_buscar">
									<h4>Reporte: Solucitudes de Certificados:</h4>
								</div>
...
<script>
var link = "reportes_solicitudes_certificado";/*la s final se agrega en js fuctions*/
var us = "reportes_solicitudes_certificado";/*sirve para mensaje en ventana eliminar*/
var l = "o";
var l2 = "e";/* est+ _ x {e,a,o ,etc}sirve para mensaje en ventana eliminar*/
var pr = "El";
var ar = "al";
var id = "id_pedido";
var mypage = "reportes_solicitudes_certificados.php";
</script>
<?php } ?>