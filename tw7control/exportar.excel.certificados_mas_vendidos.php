...
$hora = time();
$name_archivo  = 'Reporte_certificados_mas_vendidos__'.$_GET['fecha_filtro_inicio'].'_al_'.$_GET['fecha_filtro_fin'];
$title  = 'Reporte de Certificados mas Vendidos : '.$_GET['fecha_filtro_inicio'].' al '.$_GET['fecha_filtro_fin'];
...
foreach($data as $detalles) {
	...
	echo "<tr>";
		...
		echo "<td>".$detalles['total_venta']."</td>";  
