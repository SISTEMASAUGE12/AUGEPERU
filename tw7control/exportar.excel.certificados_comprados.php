...
$hora = time();
$name_archivo  = 'Reporte_certificados_comprados__'.$_GET['fecha_filtro_inicio'].'_al_'.$_GET['fecha_filtro_fin'];
$title  = 'Reporte de Certificados comprados : '.$_GET['fecha_filtro_inicio'].' al '.$_GET['fecha_filtro_fin'];
