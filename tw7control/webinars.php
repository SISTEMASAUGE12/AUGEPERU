...
<?php $task_=$_GET["task"]; ?>            
            <form id="registro" action="webinars.php?task=<?php echo ($task_=='edit') ?  "update" : "insert"; ?>" class="form-horizontal" method="POST" enctype="multipart/form-data" onsubmit="return aceptar()">
<?php 
...
<?php
  ...
  $paging->ejecutar();
  $paging->pagina_proceso="webinars.php";
?>
...
?>
	...
	<?php }//if meses ?> 						
                ...
                <tr>
                  ...
                  <td ><a href='https://www.educaauge.com/webinar/<?php echo $detalles["titulo_rewrite"]; ?>' target="_blank">ver enlace</a></td>                                 
                  ...
                  <td>
                    <div class="btn-eai  text-center btns btr    "  style="width:370px;">				
											<a href="index.php?page=webinars&module=Ver&parenttab=webinars
													<?php echo $_SESSION["base_url"].'&task=edit&id_webinar='.$detalles["id_webinar"]; ?>" style="color:#fff;"><span>editar</span>
											</a>
...
$(function(){
  // checked();
  // sorter();
  // reordenar('webinars.php');
});
var mypage = "webinars.php";
</script>
