...
$name_archivo  = 'Reporte_Leads_webinar_nuevos_clientes_';
$title  = 'Reporte_Leads_webinar_nuevos_clientes_ :  ';
...
if( !empty($_GET["sql_2_alterno"])){
	$_GET["sql"]=$_GET["sql_2_alterno"];	
}


$cols   = array('NOMBRE','EMAIL','CELULAR-telefono');
