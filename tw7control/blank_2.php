...
if($_SESSION["visualiza"]["tipo_asesora"]==1 ){


      $tab=array(
        "Gestión_de_Libros"=>array(
      ...
      /*
        "Examenes"=>array(
           ...
           // "Banco de preguntas" => array("url"=>"index.php?page=banco_preguntas"), // desfasado
      ...
      array(  
        ...
        "Mis Clientes"=>array(
          "ver" => array("url"=>"index.php?page=suscriptores"),
            "Contactar_Ahora" => array("url"=>"index.php?page=suscriptores_algoritmos"),
            "seguimiento" => array("url"=>"index.php?page=kardex_clientes"),
            "Contactar_eventos" => array("url"=>"index.php?page=suscriptores_eventos"),
        ), 
        "Clientes_sin_compra"=>array(
            "Contactar_toky" => array("url"=>"index.php?page=suscriptores_tokys"),
        ), 
      
        "Ventas"=>array(
          "Registrar venta cursos" => array("url"=>"index.php?page=pedidos_manuales"),
          "Registrar venta examen" => array("url"=>"index.php?page=pedidos_manuales_examenes"),
          "ver online" => array("url"=>"index.php?page=pedidos&tipo_pago=2"),
          "ver transferencia" => array("url"=>"index.php?page=pedidos&tipo_pago=1"),
        ), 

      "Certificados"=>array(
          "venta manual" => array("url"=>"index.php?page=pedidos_manuales_certificados"),
          "Seguimiento" => array("url"=>"index.php?page=solicitudes"),     		
      ), 
        "Reportes"=>array(
          // "Cursos del cliente" => array("url"=>"index.php?page=reportes_pedido_clientes"),
           "Compras del cliente" => array("url"=>"index.php?page=reportes_compras_clientes_ventas"),
            // "Clientes por curso" => array("url"=>"index.php?page=reportes_clientes_cursos"),
            "Buscar si existe Cliente" => array("url"=>"index.php?page=reportes_todos_clientes_ventas"),
        ), //array merge   
        "Tutoriales"=>array(
  ...
  $tab= array(  
    ...
    "Mis Clientes"=>array(
      "ver/registrar" => array("url"=>"index.php?page=suscriptores"),
        "Contactar_Ahora" => array("url"=>"index.php?page=suscriptores_algoritmos"),
        "Contactar_eventos" => array("url"=>"index.php?page=suscriptores_eventos"),
        "seguimiento" => array("url"=>"index.php?page=kardex_clientes"),
    ), 
  ...
  "Clientes_sin_compra"=>array(
    ...
    "Ventas"=>array(
      "Registrar manual" => array("url"=>"index.php?page=pedidos_manuales"),
      "ver online" => array("url"=>"index.php?page=pedidos&tipo_pago=2"),
      "ver transferencia" => array("url"=>"index.php?page=pedidos&tipo_pago=1"),
    ), 
