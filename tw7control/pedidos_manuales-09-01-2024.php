...
if($_GET["task"]=='insert'){
	...
	$valido_correo_y_especialidad=executesql("select email,dni,id_especialidad from suscritos where id_suscrito='".$_POST["id_suscrito"]."' ");
							...
							if(isset($_POST['cursos_dependientes'])){  // si hay cursos selecionados 
								...
								if( $_POST['id_tipo'] == '2' ){  // si es ::2 es un libro 
									...
									*/
									...
									// echo var_dump(arma_insert("solicitudes_libros",$campos_solicitudes,"POST"));
									// exit();
...
<!-- Data Pedido principal... -->
				...
				<div id="collapseThree" class="panel-collapse collapse in " role="tabpanel" aria-labelledby="headingThree">
					<div class="panel-body">
										...
										<div class="form-group">
											<div class="col-sm-12"><h3>Datos Para Validación* :</h3></div>
											<div class="col-sm-4 ">
										...
										<div class="form-group">
											<div class="col-sm-10 ">
													<h3>Datos para solicitud de Libro: <small style="color:red;">*obligatorios </small></h3>
											</div>
										</div>
										...
										<div class="form-group">
											<div class="col-sm-5">
												...
												<?php create_input("text","direccion",$solicitudes["direccion"],"form-control",$table,"    ",$agregado); ?>
											</div>
											<div class="col-sm-5">
												<label for="inputPassword3" class=" control-label"> Referencia: (*cliente )</label>
												<?php create_input("text","referencia",$solicitudes["referencia"],"form-control",$table,"   ",$agregado); ?>
											</div>
