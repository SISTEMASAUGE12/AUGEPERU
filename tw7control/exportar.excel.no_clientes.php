...
$hora = time();
$name_archivo  = 'Reporte_clientes_sin_compras__'.$_GET['fecha_filtro_inicio'].'_al_'.$_GET['fecha_filtro_fin'];
$title  = 'Reporte de  Clientes sin compras: '.$_GET['fecha_filtro_inicio'].' al '.$_GET['fecha_filtro_fin'];
