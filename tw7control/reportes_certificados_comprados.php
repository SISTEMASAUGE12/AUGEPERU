...
if($_GET["task"]=='finder'){
 ...
 $sql.= " ORDER BY lp.fecha_registro DESC";
  ...
  $paging->ejecutar();
  $paging->pagina_proceso="reportes_certificados_comprados.php";
?>
  <table id="example1" class="table table-bordered table-striped">
		...
		<a href="javascript:fn_exportar('tipo_form=1&fecha_filtro_inicio=<?php echo $fecha_excel_inicio;?>&fecha_filtro_fin=<?php echo $_GET["fechabus_2"];?>','certificados_comprados');" class="btn btn-primary excel "  > Excel</a>
...
<script>
var link = "reportes_certificados_comprado";/*la s final se agrega en js fuctions*/
var us = "reportes_certificados_comprado";/*sirve para mensaje en ventana eliminar*/
var l = "o";
var l2 = "e";/* est+ _ x {e,a,o ,etc}sirve para mensaje en ventana eliminar*/
var pr = "El";
var ar = "al";
var id = "id_pedido";
var mypage = "reportes_certificados_comprados.php";
</script>
<?php } ?>