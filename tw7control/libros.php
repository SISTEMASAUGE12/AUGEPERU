...
<?php $task_=$_GET["task"]; ?>            
            <form id="registro" action="libros.php?task=<?php echo ($task_=='edit') ?  "update" : "insert"; ?>" class="form-horizontal" method="POST" enctype="multipart/form-data" onsubmit="return aceptar()">
<?php 
...
*/ ?>
					...
					<div class="form-group">
						...
						<div class="col-sm-3 criterio_buscar">
									<?php crearselect("id_cat", "select id_cat,titulo from categorias where id_tipo='".$_GET["id_tipo"]."' and estado_idestado=1 order by titulo asc", 'class="form-control" requerid  onchange="javascript:display(\'libros.php\',this.value,\'cargar_subcategorias\',\'id_sub\')"', $id_cat, "-- categorias --"); ?>
						</div>
                ...
                <div class="form-group">
                  <label for="inputPassword3" class="col-md-2 col-sm-2 control-label">
										Imágen pequeña - listado de cursos<small>(*mascara video)</small><br/>
...
<?php
  ...
  $paging->ejecutar();
  $paging->pagina_proceso="libros.php";
?>
...
<?php }//if meses ?>
                  ...
                  <td class=" short"><?php echo $detalles["usuario"]; ?></td>                                
									<td>
...
$(function(){
  checked();
  sorter();
  reordenar('libros.php');
});
var mypage = "libros.php";
</script>
              ...
              <div class="bg-gray-light">
									...
									<div class="col-sm-8 criterio_buscar">
										<div class="col-sm-7 criterio_buscar" style="padding-bottom:8px;">
											<?php crearselect("id_cat", "select id_cat, titulo from categorias where id_tipo='".$_GET["id_tipo"]."' order by titulo asc", 'class="form-control"  style="border:1px solid #CA3A2B;" onchange="javascript:display(\'libros.php\',this.value,\'cargar_subcategorias\',\'id_sub\')"', '', " Todas las  categorias "); ?>
										</div>
