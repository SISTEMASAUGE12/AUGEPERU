...
if($_GET["task"]=='insert' || $_GET["task"]=='update'){
  ...
  $_POST["id_tipo"]=2; // ara cursos generales 
  ...
  if($_GET["task"]=='insert'){
    ...
    if(isset($_FILES['imagen_silabo']) && !empty($_FILES['imagen_silabo']['name'])){
      $_POST['imagen_silabo'] = carga_imagen('files/images/certificados/','imagen_silabo','','1262','760');
    ...
    <div class="col-md-12">
      ...
      <div class="box box-info">
        <div class="box-header with-border">			
          <h4 class="box-title"><?php echo ($_GET["task"]=="edit") ? 'Editar' : 'Agregando'; ?>Certificado para los Cursos ESPECIALIDADES  </h4>
        </div><!-- /.box-header -->
<?php $task_=$_GET["task"]; ?>
        <!-- form start -->
        <form id="registro" action="certificado_3formas.php?task=<?php echo ($task_=='edit') ?  "update" : "insert"; ?>" class="form-horizontal" method="POST" enctype="multipart/form-data" onsubmit="return aceptar()">
<?php 
              ...
              <div class="form-group" style="  padding-left:40px;" >
													...
													<div class="form-group" style="   " >
														<div class="col-sm-10 ">
															...
															<?php 
															create_input("text","titulo_curso",$data_producto["titulo_curso"],"form-control",$table," autocomplete='off' onkeyup='autocompletar_curso_venta(2)' ",''); 	
															?>
...
<?php
  ...
  $bd->close();
    ...
    INNER JOIN estado e ON cv.estado_idestado=e.idestado 
				WHERE cv.estado_idestado != 100 and cv.id_tipo=2 
	"; 
  ...
  $paging->ejecutar();
  $paging->pagina_proceso="certificado_3formas.php";
?>
...
$(function(){
  checked();
  sorter();
  reordenar('certificado_3formas.php');
});
var mypage = "certificado_3formas.php";
</script>
<?php }else{ ?>
<div class="box-body">
  <div id="example1_wrapper" class="dataTables_wrapper form-inline dt-bootstrap no-footer">
    <form action="javascript: fn_buscar();" id="frm_buscar" name="frm_buscar">
      <input type="hidden" name="id_tipo" value="2"> <!-- *para especialdades -->
