...
if($_GET["task"]=='finder'){
  ...
  $sql= "SELECT lp.*,YEAR(lp.fecha_registro) as anho, MONTH(lp.fecha_registro) as mes, e.nombre AS estado ,s.email as email,  CONCAT(s.nombre,' ',s.ap_pa,' ',s.ap_ma )as suscritos , s.dni as dni, s.telefono, pp.codigo as codped, pp.tipo_pago, ce.id_examen, ce.titulo as examen, ce.precio as precioc 
 ...
 $sql.= " ORDER BY lp.id_linea DESC";
  ...
  $paging->ejecutar();
  $paging->pagina_proceso="reportes_examenes_vendidos.php";
?>
  <table id="example1" class="table table-bordered table-striped">
		...
		<a href="javascript:fn_exportar('tipo_form=1&fecha_filtro_inicio=<?php echo $fecha_excel_inicio;?>&fecha_filtro_fin=<?php echo $_GET["fechabus_2"];?>','examenes_vendidos');" class="btn btn-primary excel "  > Excel</a>
...
?>        
       <tr>
        ...
        <td class="cnone"><?php echo $detalles["id_examen"]; ?></td>
        <td class="cnone"><?php echo $detalles["examen"]; ?></td>
            ...
            <form action="javascript: fn_buscar();" id="frm_buscar" name="frm_buscar">
              <div class="bg-gray-light">
								<div class="col-sm-12 titulo_reporte criterio_buscar">
									<h4>Reporte: examenes  del cliente:</h4>
								</div>
...
<script>
var link = "reportes_examenes_vendido";/*la s final se agrega en js fuctions*/
var us = "reportes_examenes_vendido";/*sirve para mensaje en ventana eliminar*/
var l = "o";
var l2 = "e";/* est+ _ x {e,a,o ,etc}sirve para mensaje en ventana eliminar*/
var pr = "El";
var ar = "al";
var id = "id_pedido";
var mypage = "reportes_examenes_vendidos.php";
</script>
<?php } ?>