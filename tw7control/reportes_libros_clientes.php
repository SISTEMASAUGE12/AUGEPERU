...
if($_GET["task"]=='finder'){
  ...
  if(isset($_GET['criterio_usu_per']) && !empty($_GET['criterio_usu_per'])){
    ...
    $sql.= " AND ( c.codigo LIKE '".$stringlike."%' or s.dni LIKE '".$stringlike."%' or s.nombre LIKE '".$stringlike."%' or s.email LIKE '".$stringlike."%' or s.telefono LIKE '".$stringlike."%' or s.ap_pa LIKE '".$stringlike."%' or s.ap_ma LIKE '".$stringlike."%' )"; 
  }else{
 ...
 // echo $sql;
  ...
  $paging->ejecutar();
  $paging->pagina_proceso="reportes_libros_clientes.php";
?>
  <table id="example1" class="table table-bordered table-striped">
		...
		<a href="javascript:fn_exportar('tipo_form=1&fecha_filtro_inicio=<?php echo $fecha_excel_inicio;?>&fecha_filtro_fin=<?php echo $_GET["fechabus_2"];?>','libros_clientes');" class="btn btn-primary excel "  > Excel</a>
...
?>
        ...
        <th class="sort cnone">Celular</th>
			  <th class="sort cnone" width="100">Estado del Libro</th>
      </tr>
<?php }//if meses 
...
?>        
       <tr>
        ...
        <td class="cnone"><?php if($detalles["estado"]==2){ echo "Pendiente"; }elseif($detalles["estado"]==3){ echo "Rechazado"; }else{ echo "Aprobado";} ?></td>
      </tr>
<?php endwhile; ?>
    </tbody>
  </table>
...
<div class="box-body"><div id="example1_wrapper" class="dataTables_wrapper form-inline dt-bootstrap no-footer">
  <form action="javascript: fn_buscar();" id="frm_buscar" name="frm_buscar"><div class="bg-gray-light">
      ...
      <?php create_input('text','criterio_usu_per','',"form-control pull-right",$table,'placeholder="Ingresa cod.Libro o DNI "'); ?>
    </div>
...
<script>
var link = "reportes_libros_cliente";/*la s final se agrega en js fuctions*/
var us = "reportes_libros_cliente";/*sirve para mensaje en ventana eliminar*/
var l = "o";
var l2 = "e";/* est+ _ x {e,a,o ,etc}sirve para mensaje en ventana eliminar*/
var pr = "El";
var ar = "al";
var id = "id_pedido";
var mypage = "reportes_libros_clientes.php";
</script>
<?php } ?>