...
$hora = time();
$name_archivo  = 'Reporte_examenes_mayor_puntaje_'.$_GET['fecha_filtro_inicio'].'_al_'.$_GET['fecha_filtro_fin'];
$title  = 'Reporte Examenes Mayor Puntaje  '.$_GET['fecha_filtro_inicio'].' al '.$_GET['fecha_filtro_fin'];
