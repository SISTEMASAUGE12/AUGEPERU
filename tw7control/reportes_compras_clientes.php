...
if( $_GET["task"]=='edit'){
  if($_GET["task"]=='edit'){ $usuario=executesql("select * from pedidos where id_pedido='".$_GET["id_pedido"]."'",0);} 
?>
...
<section class="content">
  <div class="row"><div class="col-md-12"><div class="box box-info">
    <div class="box-header with-border">
      <h3 class="box-title">COMPRAS DE CLIENTES</h3>
    </div><!-- /.box-header -->
<?php $task_=$_GET["task"]; ?>
    <!-- form start -->
        ...
        <div class="panel-group" id="accordion" role="tablist" aria-multiselectable="true">
          <div class="panel panel-default">
            <div class="panel-heading" role="tab" id="headingOne">
              <h4 class="panel-title"><a role="button" data-toggle="collapse" data-parent="#accordion" href="#collapseOne" aria-expanded="true" aria-controls="collapseOne">Datos Pedido</a></h4>
             </div>
              ...
              <div class="box-footer">
                <div class="form-group">
                  <div class="col-sm-10 text-center">
                    <button type="button" class="btn bg-gray btn-flat" onclick="javascript:gotourl('<?php echo $link2; ?>');">Cerrar</button>										
                  </div>
...
<script>
var link = "reportes_compras_cliente";/*la s final se agrega en js fuctions*/
var us = "reportes_compras_clientes";/*sirve para mensaje en ventana eliminar*/
var l = "o";
var l2 = "e";/* est+ _ x {e,a,o ,etc}sirve para mensaje en ventana eliminar*/
var pr = "El";
var ar = "al";
var id = "id_pedido";
var mypage = "reportes_compras_clientes.php";
</script>
</section><!-- /.content -->
<?php
  ...
  $sql= "SELECT pp.*,YEAR(pp.fecha_registro) as anho, MONTH(pp.fecha_registro) as mes, e.nombre AS estado ,s.email as email,  CONCAT(s.nombre,' ',s.ap_pa,' ',s.ap_ma )as suscritos , s.telefono,  s.dni as dni  , ban.nombre as banco,  u.nomusuario as usuariox   
	FROM pedidos pp 
  ...
  if(isset($_GET['criterio_usu_per']) && !empty($_GET['criterio_usu_per'])){
    ...
    $pos = strpos($sql, 'WHERE');
      $sql.= (($pos === false) ? "WHERE" : "AND" )."  ( s.dni LIKE '".$stringlike."%' or s.nombre LIKE '".$stringlike."%' or s.email LIKE '".$stringlike."%' or pp.codigo LIKE '".$stringlike."%'  or pp.id_pedido LIKE '".$stringlike."%' ) "; 
  }else{
	...
	if(!empty($_GET['estado_pago']) ){
			$pos = strpos($sql, 'WHERE');
      $sql.= (($pos === false) ? "WHERE" : "AND" )." pp.estado_pago = '".$_GET['estado_pago']."'";
	}
    ...
    $sql .= " AND s.id_especialidad='".$_GET['id_especialidad']."'  ";		
}

		if(!empty($_GET['fechabus_1']) && !empty($_GET['fechabus_2'])) {
			$pos = strpos($sql, 'WHERE');
      $sql.= (($pos === false) ? "WHERE" : "AND" )." DATE(pp.fecha_registro)  BETWEEN  DATE('".$_GET['fechabus_1']."')  and DATE('".$_GET['fechabus_2']."')  ";		
	}
 ...
 // echo $sql; 
  ...
  $paging->ejecutar();
  $paging->pagina_proceso="reportes_compras_clientes.php";
?>
  ...
  <?php if($_SESSION["visualiza"]["idtipo_usu"] ==1 &&  ($_SESSION["visualiza"]["idusuario"] ==6 || $_SESSION["visualiza"]["idusuario"] ==80 ) ){  ?> 
		...
		<a href="javascript:fn_exportar('tipo_form=1&fecha_filtro_inicio=<?php echo $fecha_excel_inicio;?>&fecha_filtro_fin=<?php echo $_GET["fechabus_2"];?>','compras_clientes');" class="btn btn-primary excel "  > Excel</a>
...
?>
          ...
          <th class="sort cnone" width="30">#c</th>
...
<?php
      if( $detalles["categoria_venta"] == 2){  // si venta de certificado 
  $line=executesql("SELECT c.titulo as titulo, cer.id_certificado, cer.titulo as titulo_certificado,  c.codigo FROM suscritos_x_certificados lp INNER JOIN certificados cer ON lp.id_certificado=cer.id_certificado  INNER JOIN cursos c ON lp.id_curso = c.id_curso WHERE lp.id_pedido = '".$detalles['id_pedido']."' ORDER BY lp.ide DESC");
...
}else{  // si e sventa de curso normal 
...
?>
    ...
    <?php if(  isset($n_solicitudes) ){  // si fue certificado  ?>
        <td> <b> Certificado: </b> </td>
            ...
            <form action="javascript: fn_buscar();" id="frm_buscar" name="frm_buscar">
              <div class="bg-gray-light">
								<div class="col-sm-12 titulo_reporte criterio_buscar">
									<h4>Reporte: Compras del cliente:</h4>
								</div>
                ...
                <div class="col-sm-2 criterio_buscar">
                  <?php create_input('text','criterio_usu_per','',"form-control pull-right",$table,'placeholder="Ingresa DNI o cod.compra "'); ?>
                </div>
...
<script>
var link = "reportes_compras_cliente";/*la s final se agrega en js fuctions*/
var us = "reportes_compras_cliente";/*sirve para mensaje en ventana eliminar*/
var l = "o";
var l2 = "e";/* est+ _ x {e,a,o ,etc}sirve para mensaje en ventana eliminar*/
var pr = "El";
var ar = "al";
