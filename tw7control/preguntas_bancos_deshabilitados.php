...
<?php $task_=$_GET["task"]; ?>
        <!-- form start -->
        <form id="registro" action="preguntas_bancos_deshabilitados.php?task=<?php echo ($task_=='edit') ?  "update" : "insert"; ?>" class="form-horizontal" method="POST" enctype="multipart/form-data" onsubmit="return aceptar()">
<?php 
...
<?php
  ...
  $paging->ejecutar();
  $paging->pagina_proceso="preguntas_bancos_deshabilitados.php";
?>
...
$(function(){
  checked();
  sorter();
  // reordenar('preguntas_bancos_deshabilitados.php');
});
var mypage = "preguntas_bancos_deshabilitados.php";
</script>
<?php }else{ ?>
<div class="box-body">
...
<script>
var us = "pregunta";
var link = "preguntas_bancos_deshabilitado";
var ar = "la";
var l = "a";
var l2 = "a";
var pr = "La";
