...
$hora = time();
$name_archivo  = 'Reporte_libros_clientes__'.$_GET['fecha_filtro_inicio'].'_al_'.$_GET['fecha_filtro_fin'];
$title  = 'Reporte de Libros Clientes: '.$_GET['fecha_filtro_inicio'].' al '.$_GET['fecha_filtro_fin'];
