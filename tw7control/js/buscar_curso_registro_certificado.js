function autocompletar_curso_venta(tipo_curso) {
	...
	if (nombre.length > min_length) {
		let _url='proceso_busqueda_curso_en_certificados.php';

		if(tipo_curso ==2){ // 2:: certificafos de especialidades 
			console.log("se busca cursos de especialidades ");
			_url='proceso_busqueda_curso_en_certificados_especialidades.php';
		}
...
function seleccionar_add_curso_venta_manual(id,nombre,tipo){    
	...
	let ides_dependientes_string= $('input[name="cursos_dependientes[]"]').val();
