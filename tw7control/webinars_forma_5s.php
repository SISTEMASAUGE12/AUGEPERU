...
if($_GET["task"]=='neworden'){
  ...
  $urlrewrite=armarurlrewrite($urlrewrite,1,"webinars","id_webinar","titulo_rewrite",$where);
	...
	$_POST['tipo']=5; /* registro desde facebook o gmail */

  $campos=array('id_curso','tipo','titulo_seo','titulo', array('titulo_rewrite',$urlrewrite),'titulo_1','detalle_1','link_video','link_chat','link_externo','titulo_2','link_vimeo_formulario','detalle_2','estado_idestado','pdf_1_titulo','pdf_2_titulo','titulo_boton_link','link_boton_2','color_fondo_boton_link','color_boton_link','etiqueta_registro_1','etiqueta_registro_2','fecha_en_texto','hora_en_texto','encargado_webi','etiqueta_infusion','ante_titulo','texto_link_externo'); 
	


  $campos=array_merge($campos,array('titulo_formulario','boton_formulario','gracias_link_wsp','titulo_boton_action', 'link_boton_action')); 
	
  $campos=array_merge($campos,array('titulo_gracias','link_gracias','titulo_carta','link_carta','titulo_carta_2','link_carta_larga')); 
  ...
  if($_GET["task"]=='insert'){
    ...
    /*
		 echo var_dump(arma_insert('webinars',array_merge($campos,array('fecha_registro','orden')),'POST'));
		 exit();
		*/
...
<?php $task_=$_GET["task"]; ?>            
            <form id="registro" action="webinars_forma_5s.php?task=<?php echo ($task_=='edit') ?  "update" : "insert"; ?>" class="form-horizontal" method="POST" enctype="multipart/form-data" onsubmit="return aceptar()">
<?php 
...
?>
              <div class="box-body   <?php echo !empty($_GET["id_webinar"])?'detalle_editar':'';?>  "   >
								...
								<?php include('inc/data_webinar_5.php');?>
...
<?php
  ...
  $paging->ejecutar();
  $paging->pagina_proceso="webinars_forma_5s.php";
?>
...
?>
							...
							<tr role="row">
								...
								<th class="unafbe "  style="width:170px;">Opciones</th>
							</tr>
	<?php }//if meses ?> 						
                ...
                <tr>
                  ...
                  <td class="sort cnone"><?php echo $detalles["etiqueta_infusion"]; ?></td>                                 
                  <td><a href='https://www.educaauge.com/capacitate/<?php echo $detalles["titulo_rewrite"]; ?>' target="_blank">ver enlace</a></td>                                 
                  ...
                  <td>
                    <div class="btn-eai  text-center btns btr    "  style="width:170px;">				
...
$(function(){
  // checked();
  // sorter();
  // reordenar('webinars_forma_5s.php');
});
var mypage = "webinars_forma_5s.php";
</script>
