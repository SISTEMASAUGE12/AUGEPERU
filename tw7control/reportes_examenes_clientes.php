...
if($_GET["task"]=='finder'){
 ...
 $sql.= " ORDER BY se.orden DESC";
  ...
  $paging->ejecutar();
  $paging->pagina_proceso="reportes_examenes_clientes.php";
?>
  <table id="example1" class="table table-bordered table-striped">
		...
		<a href="javascript:fn_exportar('tipo_form=1&fecha_filtro_inicio=<?php echo $fecha_excel_inicio;?>&fecha_filtro_fin=<?php echo $_GET["fechabus_2"];?>','examenes_clientes');" class="btn btn-primary"  > Excel</a>
...
<div class="box-body"><div id="example1_wrapper" class="dataTables_wrapper form-inline dt-bootstrap no-footer">
  <form action="javascript: fn_buscar();" id="frm_buscar" name="frm_buscar"><div class="bg-gray-light">
  	...
  	<div class="col-sm-12 titulo_reporte criterio_buscar">
			<h4>Reporte de examenes por clientes:</h4>
    </div>
  	<div class="col-sm-4 criterio_buscar">
      <?php create_input('text','criterio_usu_per','',"form-control pull-right",$table,'placeholder="Ingresa DNI .."'); ?>
    </div>
...
<script>
var link = "reportes_examenes_cliente";/*la s final se agrega en js fuctions*/
var us = "reportes_examenes_cliente";/*sirve para mensaje en ventana eliminar*/
var l = "o";
var l2 = "e";/* est+ _ x {e,a,o ,etc}sirve para mensaje en ventana eliminar*/
var pr = "El";
var ar = "al";
var id = "id_pedido";
var mypage = "reportes_examenes_clientes.php";
</script>
<?php } ?>