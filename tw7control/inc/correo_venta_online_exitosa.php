...
$url= 'https://www.educaauge.com/';
$email= $nclient[0]["email"];
...
<p style="font-size: 15px"><br><br><br> Estimado(a) '.$nombre_suscritos.' <br>'.$dominio.', le hace llegar el detalle de su pedido (<strong>Cod. de Pedido:</strong>'.$_POST["id_pedido"].'): <br></br>
</p>
	...
	//saco el valor de cada elemento
		...
		<div style="width:100%;float:left;padding:20px 15px;margin:0;"><a >										
					...
					<div style="display:inline-block;">
						...
						<p style="font-size: 14px;padding: 1px 0;color:#333;margin:2px 0;">Cantidad: <span style="float: right;font-weight: 800;"> 1 </span></p>											
					</div>  
