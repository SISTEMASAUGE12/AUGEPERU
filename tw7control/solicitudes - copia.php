                        ...
                        */ ?>						
                        ...
                        <?php /*  OCULTADO UBIGEO 
                          ...
                          <?php create_input("text","direccion",$usuario["direccion"],"form-control",$table,"disabled",$agregado); ?>
												...
												<div class="form-group">
                          <label for="inputPassword3" class="col-sm-2 control-label">AGENCIA DE ENVIO: (antes de actualizacion )</label>
                          <div class="col-sm-3">
                          <?php create_input("text","agencia",$usuario["agencia"],"form-control",$table,"disabled",$agregado); ?>
                          </div>
                        </div>  
// END UBIGUEO OCULTADOS XQ TODO SERA DIGITAL 
*/ ?>
        ...
        <td>
          <?php 
            ...
            <div class="btn-eai btr text-center" style="width:70px;">
              <a href="pdf/certificado/<?php echo $detalles["ide"]; ?>" style="color:#fff;background:green;<?php echo $mostrar_pdf;?>" target="_blank" ><i class="fa fa-eye"></i> PDF</a>
            </div>
          <?php } ?> 
        </td>
