...
<?php $task_=$_GET["task"]; ?>            
            <form action="suscriptores_tokys.php?task=<?php echo ($task_=='edit') ?  "update" : "insert"; ?>" class="form-horizontal" method="POST" autocomplete="OFF" onsubmit="return aceptar()">
<?php 
...
<?php
  ...
  // sino esta q usa el buscador 
	...
	LEFT JOIN especialidades ep ON s.id_especialidad=ep.id_especialidad 
		WHERE     s.dni !='' and s.dni is NOT NULL and s.id_especialidad !='' and s.id_especialidad is NOT NULL and    s.idusuario='".$_SESSION["visualiza"]["idusuario"]."'  ".$sql62;
  ...
  $paging->ejecutar();
  $paging->pagina_proceso="suscriptores_tokys.php";
?>
...
<script>
$(function(){
  // reordenar('suscriptores_tokys.php');
  checked();
  // sorter();
});
</script>
              ...
              <div class="bg-gray-light">
                <div class="col-sm-12" style="padding-bottom:20px;">									
									...
									<div class="col-sm-2  btn-eai ">                  
										<a href="https://www.educaauge.com/tw7control/index.php?page=suscriptores_tokys&module=Contactar_Ahora&parenttab=Mis%20Clientes" CLASS="btn " style="color:#fff;">Refrescar</a>
									</div>
...
var ar = "al";
var id = "id_suscrito";
var mypage = "suscriptores_tokys.php";
</script>
<?php } ?>