...
if($_GET["task"]=='insert'){
  $bd=new BD;  
	...
	$cursos_especialidades=executesql(" select * from cursos where estado_idestado=1 and id_tipo_curso=1 order by id_curso asc ");	 // generales  id_tipo_curso :: 1 
...
<?php $task_=$_GET["task"]; ?>
      <form action="suscritos_x_cursos_todos_generales.php?task=<?php echo ($task_=='edit') ?  "update" : "insert"; ?>" class="form-horizontal" method="POST" enctype="multipart/form-data" autocomplete="OFF" onsubmit="return aceptar()">
<?php
...
var ar = "la";
var id = "ide";
var mypage = "suscritos_x_cursos_todos_generales.php";
</script>
<?php } ?>