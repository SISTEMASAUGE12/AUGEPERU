...
if(isset($_SESSION['activate_protection']) && $_SESSION['activate_protection'][0] == true)
{
  ...
  if($tipo_form == 1)
  {
    $sql    = "select wxl.*, w.titulo as webinar, w.titulo_rewrite as webinar_rew FROM webinars_x_leads wxl 
		LEFT JOIN webinars w ON wxl.id_webinar=w.id_webinar  
		where wxl.id_webinar=".$_SESSION['activate_protection'][2]." order by wxl.orden desc ";
    ...
    $title  = 'Reporte de Leads WEBINAR: '.$exsql[0]['webinar'];
