...
if($_GET["task"]=='finder'){
  ...
  $sql= "SELECT sc.*, sc.estado as estado_sxc ,YEAR(sc.fecha_registro) as anho, MONTH(sc.fecha_registro) as mes, e.nombre AS estado ,s.email as email,  CONCAT(s.nombre,' ',s.ap_pa,' ',s.ap_ma )as suscritos , s.dni as dni, s.telefono, pp.id_pedido as codped, c.codigo AS codcur, c.titulo as titcur  
 ...
 $sql.= " ORDER BY sc.id_pedido DESC";
