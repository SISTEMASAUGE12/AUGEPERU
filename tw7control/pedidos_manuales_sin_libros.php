						...
						*/
						...
						if($id_pedido > 0){
								...
								/* REGISTRO SUSCRITO X CURSO */
										...
										// $_POST['fecha_registro'] = fecha_hora(2);
										// $_POST['estado_idestado'] = 1;
										$campos_asignacion=array('id_suscrito','id_curso','id_pedido','orden','id_tipo','validez_meses','fecha_registro','estado','dependiente','estado_idestado');
...
// rechazamos pago
  ...
  LEFT JOIN bancos ban ON pp.banco_pago=ban.id_banco   
	WHERE pp.tipo_pago='".$_GET["tipo_pago"]."'  and pp.categoria_venta=1 ";    // categoria_venta ::1 venta de cursos ventas naaturales. 
