...
if($_GET["task"]=='insert' || $_GET["task"]=='update'){
  $bd=new BD;
	...
	$campos=array('categoria_venta','id_suscrito','tipo_pago','estado_pago','total','subtotal','articulos','banco_pago','fecha_pago_off','codigo_ope_off','observacion','fecha_modificacion','estado_idestado'); /*inserto campos principales*/
  ...
  if($_GET["task"]=='insert'){
				...
				if($n_cursos > 0){ // almenos un curso 
					...
					// $_POST['orden'] = _orden_noticia("","pedidos","");
						...
						*/
						...
						if( empty($existe_voucher) ){   /* si no existe, registramos venta */
						...
						if($id_pedido > 0){
								...
								if(isset($_POST['subcategorias'])){
									...
									$_POST["nombre"]=$nclient[0]["nombre"];
									$_POST["email"]=$nclient[0]["email"];
									$_POST["telefono"]=$nclient[0]["telefono"];
									$_POST["ap_pa"]=$nclient[0]["ap_pa"];
									$_POST["ap_ma"]=$nclient[0]["ap_ma"];;
									$_POST["dni"]=$nclient[0]["dni"];;
									...
									*/
									...
									$campos_solicitudes=array('tipo','id_certificado','id_pedido','id_curso','id_suscrito','nombre','ap_pa','ap_ma','dni','api_nombre','api_paterno','api_materno','telefono','email','estado','fecha_registro','orden','estado_idestado','estado_api'); 
	...
	}else{ /** ACTUALIZAR SOLO UBIGEO - UPDATE UBIGEO */
		...
		if(isset($_POST['subcategorias'])){
			foreach($_POST['subcategorias'] as $v){
				...
				// $campos_solicitudes=array('id_agencia','id_sucursal','agencia','direccion','iddpto','idprvc','iddist','fecha_update'); 
                  ...
                  <div class="panel panel-default">
                    ...
                    <div id="collapseThree" class="panel-collapse collapse in " role="tabpanel" aria-labelledby="headingThree">
                      <div class="panel-body">
											...
											<div class="form-group">
												...
												<div class="col-sm-4 ">
													...
													<?php 
														...
														create_input("text","api_nombre",$solicitudes["api_nombre"],"form-control  " ,$table,"  ",$agregado);
													?>
												...
												<div class="col-sm-4 ">
													...
													<?php create_input("text","api_paterno",$solicitudes["api_paterno"],"form-control  ",$table," ",$agregado); ?>
												...
												<div class="col-sm-4 ">
													...
													<?php create_input("text","api_materno",$solicitudes["api_materno"],"form-control   ",$table,"  ",$agregado); ?>
										...
										END UBIGUEO COMENTADO PORQE TODO SER ADIGITAL 
											*/  ?>
											...
											<div class="form-group">
												<div class="col-sm-5">
													...
													<?php create_input("text","direccion",$solicitudes["direccion"],"form-control",$table,"  required ",$agregado); ?>
												</div>
												<div class="col-sm-5">
													<label for="inputPassword3" class=" control-label">Agencia de Envio: (*cliente )</label>
													<?php create_input("text","agencia",$solicitudes["agencia"],"form-control",$table," required ",$agregado); ?>
												</div>
                      ...
                      <div class="panel-body">
									...
									<div class="form-group">
													...
													<?php 
																	...
																	foreach($exsql1 as $row) $grp1[$row['categ']][$row['id_curso'].'_'.$row['id_certificado']] = $row['curso']; $modalidad=$row['id_tipo_curso'];
...
<?php 
if($_GET["task"]=='edit' ){ 
$detallepro=executesql("select  sxc.*  
															from pedidos p
