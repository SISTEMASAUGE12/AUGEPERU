...
var ar = "al";
var id = "id_pedido";
var mypage = "reportes_ventas_pago_efectivo.php";
</script>
</section><!-- /.content -->
<?php
 ...
 // echo  $sql; 
  ...
  $paging->ejecutar();
  $paging->pagina_proceso="reportes_ventas_pago_efectivo.php";
?>
  <table id="example1" class="table table-bordered table-striped">
		...
		<a href="javascript:fn_exportar('tipo_form=1&fecha_filtro_inicio=<?php echo $fecha_excel_inicio;?>&fecha_filtro_fin=<?php echo $_GET["fechabus_2"];?>','ventas_pago_efectivo');" class="btn btn-primary  excel "  > Excel</a>
...
?>
          ...
          <th class="sort "  width="100">Cod orden</th>
...
?>        
       <tr >
        ...
        <td ><?php 
				...
				?></td>      
        <td ><?php 
					 //codigo del pago off-line -transccion
						echo $detalles["codigo_ope_off"];				
				?></td> 
            ...
            <form action="javascript: fn_buscar();" id="frm_buscar" name="frm_buscar">
              <div class="bg-gray-light">
								<div class="col-sm-12 titulo_reporte criterio_buscar">
									<h4>Reporte: Ventas pago efectivo </h4>
								</div>
