...
$hora = time();
$name_archivo  = 'Reporte_solicitud_de_coautores_'.$_GET['fecha_filtro_inicio'].'_al_'.$_GET['fecha_filtro_fin'];
$title  = 'Reporte de  Solicitud de Coautores:: '.$_GET['fecha_filtro_inicio'].' al '.$_GET['fecha_filtro_fin'];
...
foreach($data as $detalles) {
	...
	echo "<tr>";
		...
		echo "<td>".$detalles['email_cliente']."</td>";  
