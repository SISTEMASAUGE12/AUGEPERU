...
header("Content-Disposition: attachment;filename=reporte_Clientes_del_certificado__".$hora.".xls ");  
...
<tr>
<td colspan="16" align="center"><b><font size="+2">Data CLIENTES POR CERTIFICADO </font></b></td>
</tr>
                        <tr>
                            <td style='background:#CCC; color:#000'>N.</td>
                            <td style='background:#CCC; color:#000'>FECHA</td>
                            <td style='background:#CCC; color:#000'>CODIGO CERTIFICADO </td>
                            <td style='background:#CCC; color:#000'>CERTIFICADO </td>
                            ...
                            <td style='background:#CCC; color:#000'> N° REGISTRO</td>						
                            <td style='background:#CCC; color:#000'> CODIGO PDF</td>						
                            <td style='background:#CCC; color:#000'> LIBRO</td>						
...
foreach($data as $cliente) {
  ...
  echo "<td>".$cliente['certificado']."</td>";
  ...
  echo "<td>".$cliente['order_pdf']."</td>";
  echo "<td>".$cliente['certificado_codigo']."</td>";
  echo "<td>".$cliente['certificado_libro']."</td>";
