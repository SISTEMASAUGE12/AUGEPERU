    ...
    <div class="col-md-12">
          ...
          <div class="box box-info">
            <div class="box-header with-border">
              <h3 class="box-title">COMPRAS OFFLINE: Depositos, Transferencias</h3>
            </div><!-- /.box-header -->
<?php $task_=$_GET["task"]; ?>
            <!-- form start -->
...
var ar = "al";
var id = "id_pedido";
var mypage = "reportes_ventas_offlines.php";
</script>
</section><!-- /.content -->
<?php
  ...
  $sql= "SELECT pp.*,YEAR(pp.fecha_registro) as anho, MONTH(pp.fecha_registro) as mes, e.nombre AS estado ,s.email as email,  CONCAT(s.nombre,' ',s.ap_pa,' ',s.ap_ma )as suscritos , s.dni as dni  , ban.nombre as banco  
	FROM pedidos pp 
  ...
  INNER JOIN suscritos s ON pp.id_suscrito=s.id_suscrito ";
	...
	$sql.=" WHERE pp.tipo_pago=1 "; 
  
  if (isset($_GET['criterio_mostrar'])) $porPagina=$_GET['criterio_mostrar'];
  if(isset($_GET['criterio_usu_per']) && !empty($_GET['criterio_usu_per'])){
    $stringlike=fn_filtro(substr($_GET['criterio_usu_per'], 0, 16));
    $sql.= " AND ( s.dni LIKE '".$stringlike."%' or s.nombre LIKE '".$stringlike."%' or s.email LIKE '".$stringlike."%' or pp.codigo LIKE '".$stringlike."%' or pp.codigo_ope_off LIKE '".$stringlike."%'  or pp.id_pedido LIKE '".$stringlike."%' or pp.codreferencia LIKE '".$stringlike."%' )"; 
  }else{
 ...
 // echo  $sql; 
  ...
  $paging->ejecutar();
  $paging->pagina_proceso="reportes_ventas_offlines.php";
?>
  <table id="example1" class="table table-bordered table-striped">
		...
		<a href="javascript:fn_exportar('tipo_form=1&fecha_filtro_inicio=<?php echo $fecha_excel_inicio;?>&fecha_filtro_fin=<?php echo $_GET["fechabus_2"];?>','ventas_offline');" class="btn btn-primary  excel "  > Excel</a>
...
?>
          ...
          <th class="sort cnone"  width="95">Estado del Pedido</th>
            ...
            <form action="javascript: fn_buscar();" id="frm_buscar" name="frm_buscar">
              <div class="bg-gray-light">
                ...
                <div class="col-sm-3 criterio_buscar">
                  <?php create_input('text','criterio_usu_per','',"form-control pull-right",$table,'placeholder="Busca por cod.compra o cod.transac, Dni "'); ?>
                </div>
