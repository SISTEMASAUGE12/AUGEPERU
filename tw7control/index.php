...
//inicia sesion
session_start();
//desactiva notificación de erroress
error_reporting(0);
//captura de fecha actuak
...
// $url = "http://$link/mori/w2021/augeperu/tw7control/";

//inicializa la variable global task con el metodo get
$_GET['task'] = isset($_GET['task']) ? $_GET['task'] : '';
//para el titulo de la url administador | **
...
if (!empty($_SESSION["visualiza"]["idusuario"])) {
  ...
  /*
    ...
    ?>
        <script> location.href='index?task=salir_por_inactividad&tipo_cierre=3';  </script>
    <?php 
...
<head>
  ...
  <!-- Garantizar que el stylo se cargue desde l servidor -->
...
// blank_9 -- examenes
// blank_2 -- ventas asesoras
// blank_3 -- contabilidad
// blank_4 -- ugel
// blank_8 -- examenes
    ...
    }  elseif ($_SESSION["visualiza"]["idtipo_usu"] == 13) {
      require 'blank_jefa_ventas.php';  // tipo sollo jefa de ventas
    
    } elseif ($_SESSION["visualiza"]["idtipo_usu"] == 10) {
      require 'blank_atencion_cliente.php';  // tipo sollo atención al cliente
  ...
  <script type="text/javascript">
    $(document).ready(function() {
      if ($('#registro').length) {
        $('#registro').validate(customValidate);
      }
    });
  </script>
