...
// $result_tipopago="vacio";
// $result_tipopago="<a class=' poppi-sb ' oncontextmenu='return false' onkeydown='return false' onClick='Culqi.open();'><img src='img/paga_aqui.jpg'></a>";
		...
		if($recibido == 1){
			...
			<div  class=" mostrar_cuentas">
					...
					if(!empty($bancos)){
						foreach($bancos as $data_bancos){
								// $result_tipopago.='<div><p class="poppi color4"><span class="poppi-sb color2">'.$data_bancos["nombre"].'</span>'.$data_bancos["cuenta"].'<br>'.$data_bancos["cuenta_cci"].'</p></div>';
								...
								$result_tipopago.='
															...
															<div class="bancos">		
																	<div>
																			<figure class=""><img src="img/iconos/ico-bcp.png"></figure>
																			<p class="poppi color4">
																				<span class="poppi-sb color3">Cta. Corriente:</span>
																				Nº cuenta 585-2584128-0-91 
																				<br>CCI: 00258500258412809187
																				<br><span class="poppi-sb color3">AUGE GROUP CORPORATION SAC </span>
																			</p> 
															...
															<div class="bancos">
																	<div>
																			<figure class=""><img src="img/iconos/ico-bbva.png"></figure>
																			<p class="poppi color4">
																				<span class="poppi-sb color3">Cta. Corriente:</span>
																				Nº cuenta 0011-0324-01-00034273 
																				<br>CCI: 01132400010003427311  
																				<br><span class="poppi-sb color3">AUGE GROUP CORPORATION SAC </span>
																			</p> 
															...
															<div class="bancos">		
																	<div>
																			<figure class=""><img src="img/iconos/ico-bn.png"></figure>
																			<p class="poppi color4">
																				<span class="poppi-sb color3">Cta. Corriente:</span>
																				Nº cuenta 00-525-028941
																				<br>CCI: 01852500052502894169 
																				<br><span class="poppi-sb color3">AUGE GROUP CORPORATION SAC </span>
																			</p>
																	</div>
															</div>	
															...
															<div class="bancos">		
																	<div>
																			<figure class=""><img src="img/iconos/ico-bn.png"></figure>
																			<p class="poppi color4">
																				<span class="poppi-sb color3">Cta. Ahorro empresarial:</span>
																				Nº cuenta 04-581-552039
																				<br>CCI:   
																				<br><span class="poppi-sb color3">AUGE GROUP CORPORATION SAC </span>
																			</p>
																	</div>
															...
															<div class="bancos  hide ">		 <!-- * personal hide -->
																	<div>
																			<figure class=""><img src="img/iconos/ico-bn.png"></figure>
																			<p class="poppi color4">
																				<span class="poppi-sb color3">Cta. Ahorros:</span>
																				Nº cuenta 04-238-416782
																				<br>CCI: 018-238-004238416782-63  
																				<br><span class="poppi-sb color3"> RONALD AVELLANEDA MONTENEGRO </span>
																			</p>
																	</div>
															</div>	
																	';
			...
			$result_tipopago.='
                    ...
                    <div class="bancos lleva_yape  text-center ">
										...
										<div class="bancos">
													<figure class="rel text-center" style="padding-bottom:25px;"><img src="img/iconos/ico-bn-2.png"></figure>
													<p class="poppi color4" style="max-width:316px;margin:auto;font-size:16px;">
														<b class="poppi-sb color2 ">Banco de la Nación</b>
															<br>	Nº cuenta 00-525-028941 </br> 
															CCI: 01852500052502894169
														 <!-- <br>CCI: 01852500052502894169 -->
														<br><b class="poppi-sb color3"> AUGE GROUP CORPORATION SAC		</b> </br></br>

													<!-- 
														<b class="poppi-sb color2 ">Cta. Ahorros:</b>
														<br> Nº cuenta 04-238-416782
														<br>CCI: 018-238-004238416782-63  
														<br><b class="poppi-sb color2 "> RONALD AVELLANEDA MONTENEGRO </b> 	<br> 
														-->
													</p>
										</div>
										';
