...
//$sqlt="SELECT d.id_doce, d.nombres, d.dni, d.correo, d.celular, d.especialidad, d.departamento, d.fecha_reg, d.hora_reg, d.usuario, d.estado, d.escala FROM docentes AS d ORDER BY d.id_doce DESC";
 $sql= "SELECT s.*, YEAR(s.fecha_registro) as anho, MONTH(s.fecha_registro) as mes, e.nombre AS estado, CONCAT(s.nombre,' ',s.ap_pa,' ',s.ap_ma )as suscritos, ep.titulo as especialidad   , pa.nombre   as pais 
	FROM suscritos s 
  LEFT JOIN paises pa ON s.id_pais= pa.id_pais  
...
<tr>
<td colspan="16" align="center"><b><font size="+2">Data Usuarios de Perú</font></b></td>
</tr>
                        <tr>
                            <td style='background:#CCC; color:#000'>N.</td>
                            <td style='background:#CCC; color:#000'>PAÍS</td>
