...
<main id="perfil" class="margin_interno pagina_listado_de_cursos_comprados ">
	<div class="callout callout-inicio "><div class="row "><div class="large-12 medium-12 columns content_perfil ">
		...
		<h4 class="color1 poppi-sb">Mis cursos generales  </h4>
		...
		<ul class="tabs text-center  poppi-sb " data-tabs id="example-tabs">
			...
			<li class=" _btn_extra   bold "><a href="mis-cursos-especialidades" > IR A CURSOS DE ESPECIALIDAD </a></li>			
		</ul>
		<div class="tabs-content" data-tabs-content="example-tabs">
			<div class="tabs-panel is-active" id="panel1">
				...
				<?php
					$sql_x1="SELECT sc.*, c.orden  FROM suscritos_x_cursos sc INNER JOIN cursos c ON sc.id_curso=c.id_curso
								WHERE sc.estado_idestado=1  and c.estado_idestado=1  and  sc.estado=1 and sc.condicion=1 and  sc.id_suscrito = '".$_SESSION['suscritos']['id_suscrito']."'  and sc.especialidades=2  
			...
			<div class="tabs-panel " id="panel2">
				...
				<?php
					$sql_x1="SELECT sc.*, c.orden  FROM suscritos_x_cursos sc INNER JOIN cursos c ON sc.id_curso=c.id_curso
								WHERE sc.estado_idestado=1 and c.estado_idestado=1  and sc.estado=1  and sc.condicion=2 and  sc.id_suscrito = '".$_SESSION['suscritos']['id_suscrito']."'  and sc.especialidades=2  
									Order by c.orden desc , c.en_vivo asc  ";
					$suscur = executesql($sql_x1);
