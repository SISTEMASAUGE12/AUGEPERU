...
// $sql.=" Group BY c.id_cat ORDER BY c.orden DESC ";
...
if($paging->numTotalRegistros>0){ while ($detalles = $paging->fetchResultado()):
    ...
    <div class="large-4 medium-4 columns   mostrar_listado_categorias "><?php include("inc/categoria.php") ?></div>
<?php
	endwhile;
	?>
		<script >
