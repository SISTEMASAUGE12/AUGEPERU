	...
	<form id="form-regis"  class="cotizar_index" method="post" enctype="multipart/form-data">
		...
		-->
			...
			<div class="celu large-12 columns ">
				<div class=" _lleva_banderas " >
					<dl id="sample" class="dropdown">
						<!-- <dt><a href="#"><span>País : </span></a></dt> -->
						<dt><a href="#"><span>
							+51 <img class="flag" src="tw7control/files/images/paises/CATS20.jpg" alt="">
							<span class="value_pais">1</span>
						</span></a></dt>
			...
			<?php 
				$paises=executesql("select * from paises  where estado_idestado=1 order by id_pais asc ");  
				foreach($paises as $row){
			?>						
							<li>
								<a id="<?php echo $row["id_pais"];?>" >
									<?php echo $row["prefijo"];?>
									<img class="flag" src="tw7control/files/images/paises/<?php echo $row["imagen"];?>" alt="" />
									<span class="value_pais"><?php echo $row["id_pais"];?></span>
								</a>
							</li>
		<?php 
				}
				...
				<input type="hidden" required class="poppi telef_paises " name="id_pais" id="id_pais" value="1"> <!--  por feceto sino marca nada se envia 1 de peru -->
