  		...
  		<div class="callout final"><div class="row  text-left ">				
  			<div class="large-3 medium-6 columns">
  				...
  				<ul class="linka text-left">
  					...
  					<li class="text-left "><span></span><a href="https://www.educaauge.com/landin_libro">Libros</a></li>
  			...
  			<div class="large-3 medium-6 columns">
  				...
  				<ul class="linka text-left">
  					...
  					<li class="text-left  hide "><span></span><a href="cesta-pago-deposito">Pago Deposito</a></li>
  					<li class="text-left "><span></span><a href="formas-de-pago">Formas de Pago</a></li>
  					<li class="text-left e  "><span></span><a href="https://www.educaauge.com/unete-al-canal-de-whatsapp">Únete a nuestro canal de WhatsApp</a></li>
  					<li class="text-left "><span></span><a href="augeperu-telegram">Únete a nuestro canal de Telegram</a></li>
  					<li class="text-left hide  "><span></span><a href="grupo-de-facebook">Grupo de facebook</a></li>
        	...
        	<div class="large-3 medium-6 large-text-left medium-text-left text-center columns">
				<div class="social-item">
					<a href="https://www.facebook.com/educaauge" title="facebook" target="_blank"><i class="fab fa-facebook-f"></i></a>
...
?>	
    <div id="ventana_emergente_opciones_acceso" class="   ">
		<div class=" _contiene_emergente  text-center ">              
			<button class="close-button gracias_close_ventana_opciones " data-close aria-label="Close modal" type="button"><img src="img/iconos/icono_cerrar_index_flota.png" class="modal_gracias_cerra_opciones" aria-hidden="true"> </button>
			<h3 class="poppi-b color1  ">¡Bienvenido!</h3>
			<figure><img src="img/imagen_gorro_1.jpg"></figure>
			...
			<div class=" large-6 medium-6 columns text-center poppi-b ">
				<a href="iniciar-sesion_v2">
					<div CLASS=" _div f_gris "> <h5 class="poppi-b blanco  ">Ingresar a <span>clases </span> </h5> </div>
				</a>
			</div>
			<div class=" large-6 medium-6 columns text-center poppi-b  ">
				<a href="#_baja_a_index_cursos" class=" _baja_a_index_cursos ">
					<div CLASS=" _div f_red "><h5 class="poppi-b blanco  "> Descubrir el curso ideal para ti</h5>	</div>
				</a>
			</div>
        </div>
    </div>	
	<script>
		...
		/** el resto del js de boton esta ne main.js  */		
	</script>
<?php
	}
...
<?php  
if($pagina=='mis_cursos'){    //emergente 	adminstrbles 
	//if($pagina=='portada' || $pagina=='mis_cursos'){ 
	if(isset( $_SESSION["suscritos"]["id_suscrito"] )){
