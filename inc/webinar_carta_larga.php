<div  class="callout banners text-left "><div class="fondo fondo3 " style="background-image:url(tw7control/files/images/webinars/<?php echo $webinars[0]['banner_2']; ?>);"><div class="row rel">
			...
			<div class="medium-8 medium-centered  data_principal text-center columns" style="float:none;">
				<?php if(!empty( $webinars[0]['link_carta_larga'])){  /* video trailer */  ?>
					<div class="rel lleva_vimeo_listado">
						<iframe src="	<?php echo $webinars[0]['link_carta_larga']; ?>"  frameborder="0" allow="autoplay; fullscreen" allowfullscreen></iframe>
					</div>
					<?php }elseif(!empty( $webinars[0]['link_carta'])){  /* video trailer */   ?>
					<div class="rel lleva_vimeo_listado">
...
<div id="curso">			
<div class="callout callout-1  ingreso poppi carta_larga "  style="padding-top:60px;" ><div class="row">

</div></div>
</div>


<?php $pestañas=executesql("select * from pestanhas_webinars where estado_idestado=1 and id_webinar='".$webinars[0]['id_webinar']."' ORDER by orden asc "); 
...
<div id="curso">			
	<div class="callout callout-1  ingreso poppi carta_corta "  style="padding:0 0 0;"><div class="row">
<?php  /* BOTON DE COMPRA directo a la cesta */ 
...
<?php $pestañas=executesql("select * from pestanhas_webinars where estado_idestado=1 and id_webinar='".$webinars[0]['id_webinar']."' ORDER by orden asc limit 3,10"); 
if( !empty($pestañas) ){ $i=1;
	foreach( $pestañas as $row){ 
		$i++;	
		$img="tw7control/files/images/webinars/".$webinars[0]['id_webinar']."/".$row['imagen'];
