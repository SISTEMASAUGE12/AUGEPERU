...
<?php   
	...
	//echo '<link rel="stylesheet" href="css/cursos_2024.css?ud='.$unix_date.'" />' ;		
...
<div class=" telefono_flotante_2  text-center poppi-sb    ">
	...
	<a href="tel:017097855" target="_blank"><img src="img/iconos/call_2.png"> Llama gratis </a>
</div>
...
<div class="block-n position-left off-canvas-absolute " id="offCanvasLeftSplit1" data-off-canvas>
	...
	<?php if(!empty($_SESSION["suscritos"]["id_suscrito"])){
				...
				<li class="sombreado_1 <?php echo ($pagina=="blog") ? "active " : ""; ?>"><a href="blog"  title="visita el blog"><img src="img/iconos/ico_menu_3.png">Noticias</a></li>				
				<li class="sombreado_2 <?php echo ($pagina=="testimonios") ? "active " : ""; ?>"><a href="testimonios"  title="testimonios"><img src="img/iconos/ico_menu_4.png">Testimonios</a></li>
				<li class="sombreado_1 <?php echo ($pagina=="tutoriales") ? "active " : ""; ?>"><a href="tutoriales"  title="tutoriales  "><img src="img/iconos/ico_menu_5.png">Tutoriales</a></li>
				<li class="sombreado_2 <?php echo ($pagina=="noso") ? "active " : ""; ?>"><a href="nosotros"  title="nosotros"> <img src="img/iconos/ico_menu_6.png"> Nosotros</a></li>
				<li class="sombreado_1 <?php echo ($pagina=="clie") ? "active " : ""; ?>"><a href="contacto"  title="contactenos"><img src="img/iconos/ico_menu_7.png">Contáctanos</a></li>
			...
			<nav>
				<ul class="no-bullet poppi">			
					<li class="btn poppi-b text-left " >
						<a href="tel:017097855" alt="llamar"  class=" _icono_llamar_tel "  > <img src="img/iconos/call_3.png">  LLAMA AL </br>(01) 7097855 </a>
					</li>
