...
<?php 
										...
										if(!empty($existe_solicitud)){ /* si ya apgo y ya envio/ tiene una solicitud enviada, blqoueamos el formulario*/ 
											/* MOstramos mensjae de alerta, de espera, */
												...
												if($existe_solicitud[0]['estado_api'] ==1 ){
													echo '<a class="poppi  btn_descarga_certificado " href="tw7control/pdf/examples/certificado/'.$existe_solicitud[0]['ide'].'" target="_blank"> Descarga tu certificado aquí </a>';
												}else{
													echo '<p class="poppi rpta_estado_envio "> Acción pendiente: Validar tus datos en el correo enviado</p>';
		...
		/** BOTON MARCAR COMO RECIBIDO  */
		/* OCULTO PORQ TODO ES DIGITAL
		...
		END BOTON MARCAR COMO RECIBIDO PORQ ES DIGITAL TODO AHORA */  ?>
