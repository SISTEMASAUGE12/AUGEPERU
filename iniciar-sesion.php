            ...
            */ ?>
            ...
            <div class="modal-inner"><div class="credentials-box">
                <form id="frm3"  class="general" method="post" enctype="multipart/form-data">
                    ...
                    <fieldset class="rel">
                        <a class="btn_login_alumno boton poppi-sb ">Ingresar</a>
                        <div class='hide monset pagoespera ' id='rptapago'>Procesando ...</div>
                    </fieldset>
                </form>
            </div></div>

            <p class="color4 poppi text-center"><a href="recuperar" class="poppi-b">Quiero Recuperar mi clave</a></p>
						  <p class="color4 poppi text-center">
								<a href="registrate_v2" class="poppi-b">¿Problemas para ingresar? 
									<small>Clic aquí para actualizar tus datos</small> 
								</a>
						</p>
