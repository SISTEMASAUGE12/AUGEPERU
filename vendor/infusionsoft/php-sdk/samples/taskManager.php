...
$infusionsoft = new \Infusionsoft\Infusionsoft(array(
	'clientId' => '9422ed7c-3e2b-4898-9e77-7aef5122857c',
	'clientSecret' => 'sRa4sAqTDZjMI96G',
	'redirectUri' => 'https://www.tuweb7.com',
));
...
if ($infusionsoft->getToken()) {
	...
	echo '<a href="' . $infusionsoft->getAuthorizationUrl() . '"> DD Click here to authorize</a>';
}
