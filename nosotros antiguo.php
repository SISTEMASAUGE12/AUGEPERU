...
<main id="nosotros">
	...
	<div class="section_nos_1">
		<img src="img/nosotros/Recurso 33.jpg" alt="">
	</div>
	...
	<div class="container" style="background-color: #db271e;">
	...
	<div class="container">
		<div class="section_nos_9 ">
			...
			<div class="section_nos_91">
				...
				<div class="section_nos_91_text">
					<h1 class="counter" data-count="95">0</h1>
	...
	<div class="container" style="background-color: #d3d3d3;">
		<div class="section_nos_13">
			<button class="btn131">Conoce más sobre nosotros</button>
