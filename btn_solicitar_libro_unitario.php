...
<p style="font-size: 14px">Ante cualquier duda, les invitamos a ponerse en comunicaci&oacute;n con nosotros.<br><br>Saludos cordiales,<br>- El Equipo '.$nombre_empresa.'<br><br></p>
	...
	$campos=array('id_suscrito','nombre_magisterio',"nombre",'ap_pa','ap_ma',"telefono","email","dni",'id_curso',"direccion","agencia","iddpto","iddist",'idprvc',"estado",'fecha_registro','estado_idestado','orden');
	...
	// exit();
	$insertado=$bd->inserta_(arma_insert('solicitudes_libros',$campos,'POST'));
