...
$sql = "SELECT c.*, ca.titulo as categoria, ca.titulo_rewrite AS catrewri, sc.titulo_rewrite AS subrewri, tc.titulo_rewrite AS tiprewri, tc.id_tipo AS tipocurso FROM cursos c
...
WHERE  c.id_tipo=1 and  c.estado_idestado = 1 and c.visibilidad=1 and c.precio > 0   ";
...
?>
    ...
    <div class="large-4 medium-4 columns nothing end "><?php include("inc/curso.php") ?></div>
<?php
	}
	?>
	<!-- 
